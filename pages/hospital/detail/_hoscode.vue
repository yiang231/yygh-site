<template>
  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      <div class="nav-item ">
        <span :onclick="'javascript:window.location=\'/hospital/'+hospital.hoscode+'\''" class="v-link clickable dark">预约挂号 </span>
      </div>
    ...
    <div class="page-container">
      <div class="hospital-detail">
        ...
        <div class="info-wrapper"><img :alt="hospital.hosname" :src="'data:image/jpeg;base64,'+hospital.logoData"
