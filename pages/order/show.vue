<template>
  ...
  <div class="nav-container page-component">
      ...
      <div class="order-detail">
        ...
        <div class="status-bar">
          ...
          <div class="right-wrapper">
            <img class="code-img" src="//img.114yygh.com/static/web/code_order_detail.png">
    ...
    <!-- 右侧内容 #end -->
    <!-- 微信支付弹出框 -->
    <el-dialog :append-to-body="true" :visible.sync="dialogPayVisible" style="text-align: left" width="500px"
               @close="closeDialog">
      <div class="container">
